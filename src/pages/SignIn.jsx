...
export default function SignIn() {
  return (
    <div className='flex flex-col justify-center items-center space-y-7 p-8 '>
      ...
      <h1 className='mt-4 text-2xl font-semibold border-b-2 border-blue-500 pb-2 w-64 text-center mb-4'>Sign In</h1>
      <form action="" className='flex flex-col space-y-7 items-center '>
        ...
        className='border-2 border-blue-500 rounded-lg w-72 text-lg p-1' />
        <p>No account? <Link to="/sign-up"><span className='text-red-500 font-medium cursor-pointer'>Sign Up</span></Link></p>
